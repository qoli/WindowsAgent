...
| [Windows observer protocol](observation-worker-protocol.md) | Landed | Unify finite read-only memory, file, and fixed screen-region calls behind framed process boundaries. |
