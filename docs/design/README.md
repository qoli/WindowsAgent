...
| [SFTP filesystem runtime](sftp-filesystem-runtime.md) | Partially landed | Expose a dedicated elevated Windows filesystem data plane through SFTP-only SSH with no client credentials, a persistent host key, and independent lifecycle health. |
