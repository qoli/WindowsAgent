...
| [Windows process inventory](windows-process-inventory.md) | Partially landed | Return one read-only osquery-shaped process and service snapshot with PID-based relationships and no lifecycle control or semantic interpretation. |
