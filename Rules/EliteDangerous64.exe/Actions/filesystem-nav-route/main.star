CAPABILITY_ID = "elite-dangerous/filesystem/nav-route"
FILE_NAME = "NavRoute.json"
ALLOWED_EVENTS = ["NavRoute","NavRouteClear"]
ALLOWED_FIELDS = ["timestamp","event","Route"]
MAX_BYTES = 786432
CURRENT_MS = 15000
EXPIRED_FRESHNESS = "UNKNOWN"
UPDATE_MODE = "ROUTE_SNAPSHOT"
