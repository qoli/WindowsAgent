CAPABILITY_ID = "elite-dangerous/filesystem/outfitting"
FILE_NAME = "Outfitting.json"
ALLOWED_EVENTS = ["Outfitting"]
ALLOWED_FIELDS = ["timestamp","event","MarketID","StationName","StarSystem","Horizons","Items"]
MAX_BYTES = 786432
CURRENT_MS = 900000
