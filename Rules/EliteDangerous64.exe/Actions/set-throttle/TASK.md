...
This finite Action sets the requested throttle to exactly `-100`, `0`, `75`, or `100` by
looking up `SetSpeedMinus100`, `SetSpeedZero`, `SetSpeed75`, or `SetSpeed100` in the game's currently active
