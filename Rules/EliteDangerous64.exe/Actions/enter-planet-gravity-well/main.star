...
def main(ctx):
    ...
    if status["supercruise"]:
        ...
        visible_attempt = action.try_call(id="elite-dangerous/align-visible-target", inputs={"targetName": target_name, "stopBeforeAlign": False, "centerHintConfirmed": True, "confirmedHintProfile": "SUPERCRUISE_ASSIST", "positionSource": "DESTINATION", "heatPolicy": "STRICT"})
