CAPABILITY_ID = "elite-dangerous/filesystem/market"
FILE_NAME = "Market.json"
ALLOWED_EVENTS = ["Market"]
ALLOWED_FIELDS = ["timestamp","event","MarketID","StationName","StationType","StarSystem","Items"]
MAX_BYTES = 786432
CURRENT_MS = 900000
