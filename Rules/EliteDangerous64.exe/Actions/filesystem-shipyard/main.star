CAPABILITY_ID = "elite-dangerous/filesystem/shipyard"
FILE_NAME = "Shipyard.json"
ALLOWED_EVENTS = ["Shipyard"]
ALLOWED_FIELDS = ["timestamp","event","MarketID","StationName","StarSystem","Horizons","AllowCobraMkIV","PriceList"]
MAX_BYTES = 786432
CURRENT_MS = 900000
EXPIRED_FRESHNESS = "STALE"
UPDATE_MODE = "INTERACTION_SNAPSHOT"
