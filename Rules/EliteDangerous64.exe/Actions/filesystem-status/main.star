CAPABILITY_ID = "elite-dangerous/filesystem/status"
FILE_NAME = "Status.json"
ALLOWED_EVENTS = ["Status"]
ALLOWED_FIELDS = ["timestamp","event","Flags","Flags2","Pips","FireGroup","GuiFocus","Fuel","Cargo","LegalState","Latitude","Altitude","Longitude","Heading","BodyName","PlanetRadius","Balance","Destination","Oxygen","Health","Temperature","SelectedWeapon","Gravity"]
MAX_BYTES = 65536
CURRENT_MS = 15000
EXPIRED_FRESHNESS = "STALE"
UPDATE_MODE = "PERIODIC_5S"
