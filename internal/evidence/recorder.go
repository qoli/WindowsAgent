...
func (r Recorder) Run(ctx context.Context) error {
	if ctx == nil || r.Stream == nil || r.Sink == nil || r.FrameTap == nil {
		return errors.New("evidence video recorder dependencies are required")
	}
	if err := r.Config.Validate(); err != nil {
		return err
	}
	streamErr := r.Stream.Run(ctx, time.Second, func(sampleContext context.Context, sample videocapture.Sample) error {
