...
func TestEliteHyperspaceJumpAcceptsCompletedDashedVisibleTargetBeforeFSD(t *testing.T) {
	...
	if caller.alignVisibleInputs[0]["targetName"] != "87 Mu Ceti" || caller.alignVisibleInputs[0]["stopBeforeAlign"] != false || caller.alignVisibleInputs[0]["centerHintConfirmed"] != true || caller.alignVisibleInputs[0]["confirmedHintProfile"] != "HYPERSPACE_CHARGE" {
